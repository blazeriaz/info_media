                    ...
                    <div class="card-body">
						...
						echo form_open_multipart('', $attributes); ?>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-6">
									<?php echo form_input('image',set_value('image'),'placeholder= "Image Url" class="form-control" id="image"'); 
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<?php echo form_textarea('description',set_value('description'),'placeholder= "Description" class="form-control" id=""'); 
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-6">
									<?php echo form_input('datetime',set_value('datetime'),'placeholder= "Date & Time" class="form-control datetime" id="datetime"'); 
