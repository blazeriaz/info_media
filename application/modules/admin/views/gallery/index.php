                ...
                <div class="card-body">
                	<!-- Flash Message -->
						...
						<div class="form-group">
				            ...
				            <div class="col-sm-4">
				            	<?php echo form_input('search_name',$keyword_name,'placeholder= "Search Title / Description" class="form-control" id="search_name"'); ?>
							</div>
                          ...
                          <tbody>
                             <?php if($total_rows > 0 ) {
                             		...
                             		foreach ($results as $key=>$res) 
                             		{
										...
										<td><?php $title= $res['title']; echo (strlen($title)>30?substr($title,0,30)."...":$title) ;?></td>
