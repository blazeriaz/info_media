                    ...
                    <div class="card-body">
						...
						?>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<?php 
									if($this->input->post('message')){ $message = $this->input->post('message'); }else if($results['message']){ $message = $results['message']; }else{ $message =''; }
									echo form_textarea('message',$message,'placeholder= "Message" class="form-control" id=""'); 
