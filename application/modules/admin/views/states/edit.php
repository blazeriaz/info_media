                    	...
                    	<div class="card-body">
							...
							<!--<div class="form-group">
								...
								<div class="col-sm-4">
									...
									$set_country = isset($_POST['country_id']) ? $_POST['country_id'] : (isset($states['country_id']) ? $states['country_id'] : '');
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
									<?php 
									$set_name = isset($_POST['name']) ? $_POST['name'] : (isset($states['city_name']) ? $states['city_name'] : '');
							...
							<div class="form-group display_none">
                                ...
                                <div class="col-sm-4">
									<?php 
									$set_city_code = isset($_POST['city_code']) ? $_POST['city_code'] : (isset($states['city_code']) ? $states['city_code'] : '');
			 				...
			 				<div class="form-group">
                                ...
                                <div class="col-sm-10 topspace">
		                            <?php 
									if($this->input->post('status')){ $status = $this->input->post('status'); }else if($states['status']){ $status = $states['status']; }else{ $status =''; }
									?>
									<?php if($status == 1){ ?>
