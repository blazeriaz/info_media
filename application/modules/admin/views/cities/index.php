							...
							<div class="card-title col-sm-12">
								<div class="title">
									...
									<span class="create_new pull-right">
										<?php echo anchor(base_url().SITE_ADMIN_URI.'/cities/add?pagemode='.$pagestatus.'&modestatus='.$pagingstatus.'&sortingfied='.$fieldssort.'&sortype='.$ordersort,' Add New City',array('class'=>'btn btn-suc glyphicon glyphicon-plus  pull-right','title'=>'Add New City')); ?>
									</span>
								</div>
							</div>
						</div>
