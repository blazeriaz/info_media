...
class Gallery extends Admin_Controller
{
	...
	{  		
		...
		if($keyword_name){
			$where[] = array( FALSE,"(title LIKE '%$keyword_name%' or description LIKE '%$keyword_name%')");
	...
	public function add(){
		...
		if ($this->input->server('REQUEST_METHOD') === 'POST'){
			...
			//$this->form_validation->set_rules('image', 'Image Url','trim|required|callback_valid_url'); 
			$this->form_validation->set_rules('image', 'Image Url','trim|required'); 
